...
module interlaken_imp_1RYIMTC
  ...
  wire [63:0]tx_interface_0_DATA_OUT;
  ...
  assign RX_DATA_OUT[63:0] = descrambler_UNSCRAMBLED_DATA_OUT;
  ...
  assign probe2_1 = DEBUG_TRACK_DATA[0];
  assign probe3_1 = DEBUG_ERROR_COUNT[7:0];
  ...
  main_descrambler_0_0 descrambler
       (.HEADER_IN(decode_64B_67B_HEADER_OUT),
        ...
        .PASSTHROUGH(vio_2_probe_out0),
        .SCRAMBLED_DATA_IN(decode_64B_67B_0_DATA_OUT),
        .SYSTEM_RESET(gt_core_0_RX_SYSTEM_RESET),
        .UNSCRAMBLED_DATA_OUT(descrambler_UNSCRAMBLED_DATA_OUT),
        .USER_CLK(gt_core_0_RX_USR_CLK2));
  ...
  main_ila_0_0 ila_0
       (.clk(gt_core_0_RX_USR_CLK),
        ...
        .probe5(decode_64B_67B_LOCKED),
        .probe6(gt_core_0_RX_DATA),
        .probe7(descrambler_HEADER_OUT),
        .probe8(descrambler_LOCKED),
        .probe9(descrambler_UNSCRAMBLED_DATA_OUT));
  main_ila_1_0 ila_1
       (.clk(gt_core_0_TX_USR_CLK),
        .probe0(gt_core_0_TX_MMCM_LOCK_ILA),
        .probe1(gt_core_0_TX_RESET_DONE_ILA),
        .probe2(SCRAMBLED_DATA_OUT),
        .probe3(tx_interface_0_DATA_OUT),
  ...
  main_scrambler_0_0 scrambler
       (.HEADER_IN(tx_interface_0_HEADER_OUT),
        ...
        .SYSTEM_RESET(gt_core_0_TX_SYSTEM_RESET),
        .UNSCRAMBLED_DATA_IN(tx_interface_0_DATA_OUT),
        .USER_CLK(Net1));
  main_tx_interface_0_0 tx_interface_0
       (.DATA_IN(gt_frame_gen_0_TX_DATA_OUT),
        .DATA_OUT(tx_interface_0_DATA_OUT),
...
(* CORE_GENERATION_INFO = "main,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=main,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "main.hwdef" *) 
module main
   (DRP_CLK_IN_N,
    DRP_CLK_IN_P,
    Q3_CLK0_GTREFCLK_PAD_N_IN,
  ...
  interlaken_imp_1RYIMTC interlaken
       (.DATA_TO_SEND(frame_gen_TX_DATA_TO_SEND),
        ...
        .DEBUG_TRACK_DATA(gt_frame_check_0_TRACK_DATA_OUT),
        .DRP_CLK_IN(DRP_CLK_IN),
