...
\G_PROBE_OUT[2].wr_probe_out[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\G_PROBE_OUT[2].wr_probe_out[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
entity main_vio_1_0_vio_v3_0_19_probe_out_all is
  port (
    ...
    \G_PROBE_OUT[2].wr_probe_out[2]_i_5\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of main_vio_1_0_vio_v3_0_19_probe_out_all is
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[2].wr_probe_out[2]_i_2\ : label is "soft_lutpair19";
begin
...
\G_PROBE_OUT[1].PROBE_OUT0_INST\: entity work.main_vio_1_0_vio_v3_0_19_probe_out_one_0
     port map (
...
\G_PROBE_OUT[2].PROBE_OUT0_INST\: entity work.\main_vio_1_0_vio_v3_0_19_probe_out_one__parameterized0\
     port map (
...
\G_PROBE_OUT[2].wr_probe_out[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => s_den_o,
      I3 => s_dwe_o,
      I4 => \G_PROBE_OUT[2].wr_probe_out[2]_i_4\,
      I5 => \G_PROBE_OUT[2].wr_probe_out[2]_i_5\,
...
entity main_vio_1_0_vio_v3_0_19_vio is
  ...
  attribute C_PROBE_OUT0_INIT_VAL of main_vio_1_0_vio_v3_0_19_vio : entity is "1'b0";
  ...
  attribute LC_PROBE_OUT_INIT_VAL_STRING of main_vio_1_0_vio_v3_0_19_vio : entity is "256'";
...
PROBE_OUT_ALL_INST: entity work.main_vio_1_0_vio_v3_0_19_probe_out_all
     port map (
      D(1 downto 0) => xsdb_addr_2_0_p1(1 downto 0),
      \G_PROBE_OUT[1].wr_probe_out_reg[1]_0\ => PROBE_OUT_ALL_INST_n_4,
      \G_PROBE_OUT[2].wr_probe_out[2]_i_3\ => DECODER_INST_n_5,
      \G_PROBE_OUT[2].wr_probe_out[2]_i_4\ => DECODER_INST_n_6,
      \G_PROBE_OUT[2].wr_probe_out[2]_i_5\ => DECODER_INST_n_7,
      Probe_out_reg(0) => Probe_out_reg(0),
      Q(0) => p_2_in,
      SR(0) => clear,
      clk => clk,
...
architecture STRUCTURE of main_vio_1_0 is
  ...
  attribute LC_PROBE_OUT_INIT_VAL_STRING : string;
  attribute LC_PROBE_OUT_INIT_VAL_STRING of inst : label is "256'";
  attribute LC_PROBE_OUT_LOW_BIT_POS_STRING : string;
