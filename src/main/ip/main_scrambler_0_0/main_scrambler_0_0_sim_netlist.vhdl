...
architecture STRUCTURE of main_scrambler_0_0_scrambler is
  ...
  signal \SCRAMBLED_DATA_OUT1__0\ : STD_LOGIC;
  ...
  signal SCRAMBLED_DATA_OUT24_in : STD_LOGIC;
...
\SCRAMBLED_DATA_OUT[63]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A8A8A8A8A8ABA8A8"
    )
        port map (
...
\SCRAMBLED_DATA_OUT[63]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
      I0 => SCRAMBLED_DATA_OUT24_in,
      I1 => HEADER_IN(0),
      I2 => HEADER_IN(1),
      O => \SCRAMBLED_DATA_OUT1__0\
    );
