...
module main_decode_64B_67B_0_0(DATA_IN, DATA_OUT, HEADER_OUT, DATA_OUT_VALID, 
  CANDIDATE, DATA_IN_VALID, LOCKED, USER_CLK, SYSTEM_RESET, PASSTHROUGH)
/* synthesis syn_black_box black_box_pad_pin="DATA_IN[66:0],DATA_OUT[63:0],HEADER_OUT[1:0],DATA_OUT_VALID,CANDIDATE[6:0],DATA_IN_VALID,LOCKED,USER_CLK,SYSTEM_RESET,PASSTHROUGH" */;
  input [66:0]DATA_IN;
