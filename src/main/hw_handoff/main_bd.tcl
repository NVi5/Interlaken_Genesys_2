...
proc create_hier_cell_interlaken { parentCell nameHier } {
  ...
  connect_bd_net -net CANDIDATE [get_bd_pins decode_64B_67B/CANDIDATE] [get_bd_pins ila_0/probe12] [get_bd_pins vio_2/probe_in2]
  ...
  connect_bd_net -net DECODER_DATA_OUT [get_bd_pins decode_64B_67B/DATA_OUT] [get_bd_pins descrambler/DATA_IN] [get_bd_pins ila_0/probe0]
  connect_bd_net -net DECODER_DATA_OUT_VALID [get_bd_pins decode_64B_67B/DATA_OUT_VALID] [get_bd_pins descrambler/DATA_IN_VALID] [get_bd_pins ila_0/probe3] [get_bd_pins vio_2/probe_in0]
  connect_bd_net -net DECODER_PASSTHROUGH [get_bd_pins decode_64B_67B/PASSTHROUGH] [get_bd_pins vio_2/probe_out1]
  connect_bd_net -net DESCRAMBLER_DATA_OUT [get_bd_pins RX_DATA_OUT] [get_bd_pins descrambler/DATA_OUT] [get_bd_pins ila_0/probe7]
  connect_bd_net -net DESCRAMBLER_DATA_OUT_VALID [get_bd_pins DATA_OUT_VALID] [get_bd_pins descrambler/DATA_OUT_VALID] [get_bd_pins ila_0/probe6] [get_bd_pins vio_2/probe_in1]
  ...
  connect_bd_net -net SCRAMBLED_DATA_OUT [get_bd_pins encode_64B_67B/DATA_IN] [get_bd_pins ila_1/probe0] [get_bd_pins scrambler/DATA_OUT]
  ...
  connect_bd_net -net TX_INTERFACE_DATA_OUT [get_bd_pins ila_1/probe1] [get_bd_pins scrambler/DATA_IN] [get_bd_pins tx_interface_0/DATA_OUT]
  ...
  connect_bd_net -net decode_64B_67B_LOCKED [get_bd_pins decode_64B_67B/LOCKED] [get_bd_pins ila_0/probe9]
  connect_bd_net -net descrambler_LOCKED [get_bd_pins descrambler/LOCKED] [get_bd_pins ila_0/probe13]
