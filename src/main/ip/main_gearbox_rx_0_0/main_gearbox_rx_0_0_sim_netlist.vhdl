...
architecture STRUCTURE of main_gearbox_rx_0_0_gearbox_rx is
  ...
  signal \schedule[2]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \schedule[0]_i_1\ : label is "soft_lutpair2";
...
\schedule[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFE2"
    )
        port map (
...
\schedule[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
\schedule[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
\schedule[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EBAAAAAA"
    )
        port map (
